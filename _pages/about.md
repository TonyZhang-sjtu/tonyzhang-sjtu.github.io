...
profile:
  ...
  more_info: >
    <p>
    <a href="mailto:jy.zhang@sjtu.edu.cn" style="text-decoration: none; color: var(--global-theme-color); font-family: Roboto;">
      <i class="fas fa-envelope" style="margin-right: 5px; color: var(--global-text-color);"></i> jy.zhang@sjtu.edu.cn
    </a>
    </p>
    <p>
