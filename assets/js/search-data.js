    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-vl-routerbench-and-adasvd-are-accepted-to-cvpr-2026-tada-tada",
          title: 'VL-RouterBench and AdaSVD are accepted to CVPR 2026. :tada: :tada:',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/CV_Jingyuan_Zhang1217.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%74%6F%6E%79%7A%68%61%6E%67%36%36%36@%73%6A%74%75.%65%64%75.%63%6E", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/TonyZhang-sjtu", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=ditU6YoAAAAJ&hl", "_blank");
        },
      },{
      id: 'light-theme',
